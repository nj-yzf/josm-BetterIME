...
tasks.jar {
    ...
    manifest {
        attributes(
            ...
            "Plugin-Description" to "Auto-disable Chinese input method when not editing text fields. " +
                    "Prevents IME from interfering with JOSM keyboard shortcuts.",
            ...
            "Author" to "IME Toggle Plugin Developer",
